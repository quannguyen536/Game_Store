...
public class May14 extends JPanel{
	...
	public May14() {
		...
		lblNewLabel.setIcon(new ImageIcon(May14.class.getResource("/images/icons/icons8-computer-105.png")));
		lblNewLabel.setHorizontalAlignment(SwingConstants.CENTER);
		lblNewLabel.setBounds(10, 11, 121, 109);
		panel.add(lblNewLabel);
		
		JLabel lb_somay = new JLabel("Máy 14");
		...
		lb_trangthai.setIcon(new ImageIcon(May14.class.getResource("/images/icons/icons8-wi-fi-27.png")));
