...
public class May31 extends JPanel{
	...
	public May31() {
		...
		lblNewLabel.setIcon(new ImageIcon(May31.class.getResource("/images/icons/icons8-computer-105.png")));
		lblNewLabel.setHorizontalAlignment(SwingConstants.CENTER);
		lblNewLabel.setBounds(10, 11, 121, 109);
		panel.add(lblNewLabel);
		
		JLabel lb_somay = new JLabel("Máy 31");
		...
		lb_trangthai.setIcon(new ImageIcon(May31.class.getResource("/images/icons/icons8-wi-fi-27.png")));
