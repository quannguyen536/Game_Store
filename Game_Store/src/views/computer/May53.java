...
public class May53 extends JPanel{
	...
	public May53() {
		...
		lblNewLabel.setIcon(new ImageIcon(May53.class.getResource("/images/icons/icons8-computer-105.png")));
		lblNewLabel.setHorizontalAlignment(SwingConstants.CENTER);
		lblNewLabel.setBounds(10, 11, 121, 109);
		panel.add(lblNewLabel);
		
		JLabel lb_somay = new JLabel("Máy 53");
		...
		lb_trangthai.setIcon(new ImageIcon(May53.class.getResource("/images/icons/icons8-wi-fi-27.png")));
