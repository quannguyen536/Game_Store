...
public class May9 extends JPanel{
	...
	public May9() {
		...
		lblNewLabel.setIcon(new ImageIcon(May9.class.getResource("/images/icons/icons8-computer-105.png")));
		lblNewLabel.setHorizontalAlignment(SwingConstants.CENTER);
		lblNewLabel.setBounds(10, 11, 121, 109);
		panel.add(lblNewLabel);
		
		JLabel lb_somay = new JLabel("Máy 9");
		...
		lb_trangthai.setIcon(new ImageIcon(May9.class.getResource("/images/icons/icons8-wi-fi-27.png")));
